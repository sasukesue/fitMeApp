...
```
$ docker image tag app sasukesue/app
$ docker push sasukesue/app
$ docker image tag fitnessclass sasukesue/fitnessclass
$ docker push sasukesue/fitnessclass
$ docker image tag location sasukesue/location
$ docker push sasukesue/location
```
